...
sent_neg_train = load("../Inputs/paisa_sent_neg2.joblib")
sent_pos_train = load("../Inputs/paisa_sent_pos2.joblib")



for frase in sent_neg:
   if frase not in sent_neg_train:
      test_sent_neg.append(frase)
print(f"neg unseen {len(test_sent_neg)}")


for frase in sent_pos:
   if frase not in sent_pos_train:
      test_sent_pos.append(frase)
